<%@ Page Title="" Language="C#" MasterPageFile="~/mp-cliente.master" AutoEventWireup="true" CodeFile="Galeria.aspx.cs" Inherits="Galeria" %>
    ...
    <div id="thumbs" class="navigation">
        <ul class="thumbs noscript">
            <asp:Repeater ID="ModifyRepeater" runat="server" DataSourceID="fotos">
                <ItemTemplate>
                    <li>
                        <a class="thumb" id="<%#Eval("id_galeria")%>"" href="fotos.aspx?galeria=<%#Eval("id_galeria")%>" title="<%#Eval("nome")%>">
