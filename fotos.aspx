<%@ Page Title="" Language="C#" MasterPageFile="~/mp-cliente.master" AutoEventWireup="true" CodeFile="~/fotos.aspx.cs" Inherits="galeria" %>
    ...
    <form id="Form1" runat="server">
        ...
        <div id="page">
            <div id="container" class="cssescuro">
                ...
                <asp:Label ID="Label1" runat="server" Text="Forma de recebimento:" ForeColor="White"></asp:Label>
                <asp:DropDownList ID="ddlTipo" runat="server">
                    <asp:ListItem>Digital</asp:ListItem>
                    <asp:ListItem>Revelada</asp:ListItem>
                </asp:DropDownList>
                <asp:Button ID="Button1" CssClass="btn btn-primary" Style="background-color: #222; color: #fff;" runat="server" Text="Solicitar" OnClick="Button1_Click" />
